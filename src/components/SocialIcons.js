...
function SocialIcons(props: Props): React$Node {
  ...
  return (
    ...
    >
      <a href="mailto: mrghasemi1992@gmail.com" className="pointer">
        <img
      ...
      <a href="https://www.linkedin.com/in/mrghasemi1992/" className="pointer">
        <img
      ...
      <a href="https://t.me/mrghasemi1992" className="pointer">
        <img
      ...
      <a href="https://github.com/mrghasemi1992" className="pointer">
        <img
